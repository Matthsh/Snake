...
class SNAKE:
    def __init__(self):
        ...
        self.body_horizontal = pygame.image.load('snake_horizontal_body.png').convert_alpha()
        self.body_vertical = pygame.image.load('snake_vertical_body.png').convert_alpha()

        self.body_lu = pygame.image.load('snake_vody_curve_ul.png').convert_alpha()
        self.body_ld = pygame.image.load('snake_vody_curve_dl.png').convert_alpha()
        self.body_ur = pygame.image.load('snake_vody_curve_ur.png').convert_alpha()
        self.body_dr = pygame.image.load('snake_vody_curve_dr.png').convert_alpha()
...
class MAIN:
    ...
    def check_fail(self):
        if not 0 <= self.snake.body[0].x <= cell_number - 1 or not 0 <= self.snake.body[0].y <= 14:
            self.game_over()
    ...
    def draw_score(self):
        ...
        score_y = int(cell_size * 14 - 40)
        score_rect = score_surface.get_rect(center = (score_x, score_y))
        apple_rect = apple.get_rect(midright = (score_rect.left,score_rect.centery))
        bg_rect = pygame.Rect(apple_rect.left,apple_rect.top,apple_rect.width + score_rect.width + 6, apple_rect.height)

        pygame.draw.rect(screen,(150,75,255),bg_rect)
...
apple = pygame.image.load('apple3.png').convert_alpha()
game_font = pygame.font.Font('techno_hideo.ttf', 25)
